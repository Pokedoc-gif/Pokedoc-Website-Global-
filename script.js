...
const products = [
  ...
  { id: 7, category: "accessories", name: "Pokemon Eeveelutions Card Frame Case CSGC (Promo card included)", subtitle: "Complete Set Discount R1300", price: "R400 each", adminPrice: "R400", image: "https://uploads.onecompiler.io/44e4cjszf/44peumstd/Pokemon%20Eeveelutions%20Card%20Frame%20Case%20CSGC%20(Promo%20card%20included).png" },
  { id: 8, category: "accessories", name: "Umbreon Display Card Frame", subtitle: "Frame only. Does not include cards<br>Limited stock available", price: "R100 each", adminPrice: "R100", image: "https://www.image2url.com/r2/default/images/1779091184907-f5aa4037-f6fc-41b2-bd53-e1a320f273c4.png" },
  { id: 9, category: "accessories", name: "Mew Display Card Frame", subtitle: "Frame only. Does not include cards<br>Limited stock available", price: "R100 each", adminPrice: "R100", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7VlZjnoBGYDVJEae_hZ3vPmwjadPXImpUDWiQ4Jbaiw&s" },
