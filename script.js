...
const products = [
  ...
  { id: 15, category: "boxes", name: "Pokemon 151 Starters Promo Frame", subtitle: "Limited stock available", price: "R500 each", adminPrice: "R500", image: "https://spoilsandloot.com/cdn/shop/files/SimplifiedChinesePokemonCollect151FirstPartnerDisplaySet-1.webp?v=1755290660" },
  { id: 16, category: "boxes", name: "Pokemon Mega Dream Booster Box M2a", subtitle: "Limited stock available", price: "R2500 each", adminPrice: "R2500", image: "https://fandom.tokyo/cdn/shop/files/BOX_61bf7856-745e-4ce4-a252-60f89a3325cc.jpg?v=1770361559&width=416" },
  { id: 17, category: "boxes", name: "151 Pikachu Exclusive Booster Box", subtitle: "Out of Stock (Restock Pending)", price: "R1500 each", adminPrice: "R1500", image: "https://nostalgiatcg.com/cdn/shop/files/Pokemon-151C-Booster-Box_977x841_77b000d3-d9d7-4da2-858d-fb25560f88e8.webp?v=1740693807" },
  { id: 18, category: "boxes", name: "151 Psyduck Exclusive Booster Box", subtitle: "Out of Stock (Restock Pending)", price: "R1500 each", adminPrice: "R1500", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZgUr11QQpEQSvdtf4g30wwpItKfmydAqgwyJqspjuRpkaA3JiypuU5Xc&s=10" },
  { id: 19, category: "boxes", name: "151 Gengar Exclusive Booster Box", subtitle: "Out of Stock (Restock Pending)", price: "R1500 each", adminPrice: "R1500", image: "https://cdn11.bigcommerce.com/s-pmynegjr7m/images/stencil/1280x1280/products/285916/1663939/collect_slim__57633.1769622711.jpg?c=1" },
  { id: 20, category: "boxes", name: "151 Double Pikachu Exclusive Booster Box", subtitle: "Out of Stock (Restock Pending)", price: "R1500 each", adminPrice: "R1500", image: "https://uploads.onecompiler.io/44e4cjszf/44p5qq6wr/151%20Pikachu%20Exclusive%20Booster%20Box.webp" },
  { id: 21, category: "boxes", name: "151 Collection Figure Blind Box", subtitle: "Out of Stock (Restock Pending)", price: "R700 each", adminPrice: "R700", image: "https://i.ebayimg.com/images/g/mEUAAeSwxahp3Elj/s-l1200.jpg" },
  { id: 22, category: "boxes", name: "151 Puzzle Refrigerator Magnet Set", subtitle: "Out of Stock (Restock Pending)", price: "R500 each", adminPrice: "R500", image: "https://www.image2url.com/r2/default/images/1779091891978-fc0adbdd-e246-48f2-93b9-79b2f9083371.webp" },
  { id: 23, category: "boxes", name: "Ponyta 151 Booster Box CBB4C", subtitle: "Limited stock available", price: "R900 each", adminPrice: "R900", image: "https://cdn.corenexis.com/f/uhI2g1TTXSQ.webp" },
  { id: 24, category: "boxes", name: "Dragon Boat Festival Box", subtitle: "Limited stock available", price: "R800 each", adminPrice: "R800", image: "https://cdn.corenexis.com/f/Tdfi7b0p5wS.webp" }
];
